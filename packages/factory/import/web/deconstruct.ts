...
const TAG_TO_COMPONENT: Partial<Record<HtmlElement, ComponentId>> = {
  ...
  [HtmlElement.H1]: ComponentId.HEADING,
  [HtmlElement.H2]: ComponentId.HEADING,
  [HtmlElement.H3]: ComponentId.HEADING,
  [HtmlElement.H4]: ComponentId.HEADING,
  [HtmlElement.H5]: ComponentId.HEADING,
  [HtmlElement.H6]: ComponentId.HEADING,
