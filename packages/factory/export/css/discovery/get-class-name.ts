...
import { getInstanceClassHash, resolveSourceVariantId } from "../../../helpers/workspace-nodes"
 ...
 */
export const getClassNameForNode = (node: EntryNode, workspace: Workspace): string => {
 ...
 */
function getAuthoredRootClassName(node: EntryNode, workspace: Workspace): string | null {
