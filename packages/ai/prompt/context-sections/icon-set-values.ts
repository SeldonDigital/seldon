...
import { deriveSubcategoryPreset, getIconsInSubcategory } from "@seldon/core/icon-sets/helpers"
 ...
 */
export function iconSetValuesSection(iconSetId: string, workspace: Workspace): string[] {
