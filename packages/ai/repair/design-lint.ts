...
const PROPERTY_ACTION_TYPES = new Set(["set_node_properties", "set_node_state_properties"])
...
function propertyViolations(vocab: Vocabulary, key: string, value: unknown): string[] {
 ...
 */
export function collectDesignViolations(workspace: Workspace, action: WorkspaceAction): string[] {
  ...
  for (const [key, value] of Object.entries(payload.properties as Record<string, unknown>)) {
