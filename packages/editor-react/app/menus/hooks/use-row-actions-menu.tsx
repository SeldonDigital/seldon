...
/**
 * Headless "..." actions menu for generated rows. Returns slot props that
 * drive a row's trailing iconic-button slot plus the floating menu node, so no
 * hand-written markup mimics generated styling. When there are no actions the
 * slot stays reserved with a non-interactive placeholder.
 */
