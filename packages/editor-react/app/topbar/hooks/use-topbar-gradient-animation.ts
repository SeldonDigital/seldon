...
/**
 * Wires the topbar strip to the export status. Returns the ref to attach to the
 * strip element; the controller owns all paint and lifecycle.
 */
export function useTopbarGradientAnimation() {
