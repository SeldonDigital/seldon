...
export interface IconFrameRowsProps extends SVGAttributes<SVGElement> {
  className?: string
  icon?:
    | "__default__"
...
export function IconFrameRows({
  className = "",
  icon = "seldon-frameRows",
  ...props
}: IconFrameRowsProps) {
  ...
  return <Icon className={"variant-icon-QcIO90 " + className} {...props} />
}
const iconMap = {
