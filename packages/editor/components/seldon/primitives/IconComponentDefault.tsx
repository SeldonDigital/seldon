...
export interface IconComponentDefaultProps extends SVGAttributes<SVGElement> {
  className?: string
  icon?:
    | "__default__"
...
export function IconComponentDefault({
  className = "",
  icon = "seldon-componentDefault",
  ...props
}: IconComponentDefaultProps) {
  ...
  return <Icon className={"variant-icon-HucwIg " + className} {...props} />
}
const iconMap = {
