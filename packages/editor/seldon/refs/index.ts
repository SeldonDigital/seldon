...
export const SELDON_REFS: Record<SeldonRef, SeldonRefEntry> = {
  ...
  "logo": {"component":"Frame","nodeId":"component-frame-AjNqkrLb","className":"sdn-frame sdn-frame--ajnq"},
  "menuComponent": {"component":"ButtonSimple","nodeId":"component-bar-tJLcDfnC","className":"sdn-button-simple sdn-button-simple--dbgs"},
  "menuDev": {"component":"ButtonSimple","nodeId":"component-bar-EW9LJxSD","className":"sdn-button-simple sdn-button-simple--dbgs"},
  "menuEdit": {"component":"ButtonSimple","nodeId":"component-bar-8iQ7zRar","className":"sdn-button-simple sdn-button-simple--dbgs"},
  "menuFile": {"component":"ButtonSimple","nodeId":"component-bar-dBgSvhzY","className":"sdn-button-simple sdn-button-simple--dbgs"},
  "menuMode": {"component":"ButtonMenu","nodeId":"component-bar-JXHsaaaQ","className":"sdn-button-menu sdn-button-iconic--pgsr"},
  "menus": {"component":"Frame","nodeId":"component-bar-DrSavE9B","className":"sdn-frame sdn-frame--drsa"},
  "menuStates": {"component":"ButtonMenu","nodeId":"component-button-OTbyoxbN","className":"sdn-button-menu sdn-button"},
  "menuTheme": {"component":"ButtonMenu","nodeId":"component-button-uIofK8RQ","className":"sdn-button-menu sdn-button-iconic--pgsr"},
  "menuView": {"component":"ButtonSimple","nodeId":"component-bar-FUwSPfCT","className":"sdn-button-simple sdn-button-simple--dbgs"},
  ...
  "propertyLabel": {"component":"Input","nodeId":"component-item-JvSW6JpE","className":"sdn-input sdn-input--jvsw"},
  ...
  "sectionToggleIcon": {"component":"Icon","nodeId":"component-item-7MKLAjub","className":"sdn-icon sdn-icon--umgs"},
