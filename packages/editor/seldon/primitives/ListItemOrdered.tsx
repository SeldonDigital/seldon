...
export interface ListItemOrderedProps extends HTMLAttributes<
 ...
 * ```
 *****/
export function ListItemOrdered({
  className = "",
  children = sdn.children,
  htmlElement = sdn.htmlElement,
  ...props
}: ListItemOrderedProps) {
  const listItemOrderedClassName = combineClassNames(
  ...
  switch (htmlElement) {
    case "li":
      ...
      return (
        <HTMLLi
          className={listItemOrderedClassName}
...
//
const sdn: ListItemOrderedProps = {
  children: "Ordered List",
  htmlElement: "ol",
  "aria-hidden": "false",
