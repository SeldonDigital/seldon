...
} from "../parts/ListboxGroupedListbox"
...
export function ComboboxGroupedCombobox({
  ...
  icon2 = sdn.icon2,
  listboxGroupedListbox = sdn.listboxGroupedListbox,
  frame = sdn.frame,
  textLabel,
  listboxOption,
  icon3 = sdn.icon3,
  ...
  const comboboxGroupedComboboxClassName = combineClassNames(
    "sdn-combobox",
    className,
  )
  ...
  const listboxGroupedListboxProps = applyRef(
    seldonRefs,
    listboxGroupedListbox === null
      ? null
      : {
          ...sdn.listboxGroupedListbox,
          ...listboxGroupedListbox,
          className: combineClassNames(
            sdn.listboxGroupedListbox?.className,
            listboxGroupedListbox?.className,
          ),
        },
  )
  ...
  return (
    <Frame
      className={comboboxGroupedComboboxClassName}
