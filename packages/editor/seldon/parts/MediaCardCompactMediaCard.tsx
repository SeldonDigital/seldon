...
export interface MediaCardCompactMediaCardProps extends HTMLAttributes<HTMLElement> {
  className?: string
...
/*****
 * Media Card: MediaCardCompactMediaCard
 * Level: Part
 ...
 * ```
 *****/
export function MediaCardCompactMediaCard({
  className = "",
  image = sdn.image,
  frame = sdn.frame,
  textTitle,
  ...
  seldonRefs,
  ...props
}: MediaCardCompactMediaCardProps) {
  const mediaCardCompactMediaCardClassName = combineClassNames(
    "sdn-media-card",
    className,
  )
  ...
  return (
    <Frame
      className={mediaCardCompactMediaCardClassName}
...
//
const sdn: MediaCardCompactMediaCardProps = {
  "aria-hidden": "false",
