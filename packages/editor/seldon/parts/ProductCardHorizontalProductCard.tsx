...
export interface ProductCardHorizontalProductCardProps extends HTMLAttributes<HTMLElement> {
  className?: string
...
/*****
 * Product Card: ProductCardHorizontalProductCard
 * Level: Part
 ...
 * @example
 * ```tsx
 * <ProductCardHorizontalProductCard
 *   aria-hidden="false"
 *   image="/image.jpg"
 *   frame="{}"
 ...
 * ```
 *****/
export function ProductCardHorizontalProductCard({
  className = "",
  image = sdn.image,
  frame = sdn.frame,
  textSubtitle,
  ...
  seldonRefs,
  ...props
}: ProductCardHorizontalProductCardProps) {
  const productCardHorizontalProductCardClassName = combineClassNames(
    "sdn-product-card-horizontal-product-card",
    className,
  )
  ...
  return (
    <Frame
      className={productCardHorizontalProductCardClassName}
...
//
const sdn: ProductCardHorizontalProductCardProps = {
  "aria-hidden": "false",
  className: "sdn-product-card-horizontal-product-card sdn-product-card",
  image: {
