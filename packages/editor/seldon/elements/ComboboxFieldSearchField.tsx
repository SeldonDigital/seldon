...
export interface ComboboxFieldSearchFieldProps extends HTMLAttributes<HTMLElement> {
  className?: string
...
/*****
 * Combobox Field: ComboboxFieldSearchField
 * Level: Element
 ...
 * ```
 *****/
export function ComboboxFieldSearchField({
  className = "",
  icon = sdn.icon,
  input = sdn.input,
  ...
  const comboboxFieldSearchFieldClassName = combineClassNames(
    "sdn-combobox-field-search-field",
    className,
  )
  ...
  return (
    <Frame
      className={comboboxFieldSearchFieldClassName}
...
//
const sdn: ComboboxFieldSearchFieldProps = {
  "aria-hidden": "false",
  className: "sdn-combobox-field-search-field sdn-combobox-field",
  icon: {
