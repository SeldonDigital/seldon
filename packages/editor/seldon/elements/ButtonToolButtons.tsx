...
export interface ButtonToolButtonsProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  className?: string
 ...
 * ```
 *****/
export const ButtonToolButtons = forwardRef<
  HTMLButtonElement,
  ButtonToolButtonsProps
>(function ButtonToolButtons(
  {
    className = "",
    button = sdn.button,
    icon = sdn.icon,
  ...
  const buttonToolButtonsClassName = combineClassNames(
    "sdn-button-tool-buttons",
    className,
  )
  ...
  return (
    <HTMLButton className={buttonToolButtonsClassName} ref={ref} {...props}>
      {children !== undefined ? (
        children
      ) : (
        <>
...
//
const sdn: ButtonToolButtonsProps = {
  button: {
    className: "sdn-button sdn-button--xjs6",
  },
  icon: {
  ...
  textLabel: {
    className: "sdn-text-label sdn-text-label--hthm",
  },
  button2: {
    className: "sdn-button sdn-button--xjs6",
  },
