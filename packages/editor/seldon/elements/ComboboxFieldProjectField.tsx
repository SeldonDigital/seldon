...
export interface ComboboxFieldProjectFieldProps extends HTMLAttributes<HTMLElement> {
  className?: string
...
/*****
 * Combobox Field: ComboboxFieldProjectField
 * Level: Element
 ...
 * ```
 *****/
export function ComboboxFieldProjectField({
  className = "",
  icon = sdn.icon,
  input = sdn.input,
  ...
  const comboboxFieldProjectFieldClassName = combineClassNames(
  ...
  return (
    <Frame
      className={comboboxFieldProjectFieldClassName}
...
//
const sdn: ComboboxFieldProjectFieldProps = {
  "aria-hidden": "false",
