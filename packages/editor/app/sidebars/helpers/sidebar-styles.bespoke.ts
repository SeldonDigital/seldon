...
export const COLOR_SET = "var(--sdn-swatch-white)"
export const COLOR_UNSET =
  "color-mix(in srgb, var(--sdn-swatch-white) 60%, var(--sdn-swatch-offBlack))"
export const COLOR_NOT_USED =
...
export const subPropertyRowBackground =
  "color-mix(in srgb, var(--sdn-swatch-black) 70%, transparent)"
