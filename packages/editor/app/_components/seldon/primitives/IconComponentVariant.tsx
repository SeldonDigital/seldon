...
export interface IconComponentVariantProps extends SVGAttributes<SVGElement> {
  className?: string
  icon?:
    | "__default__"
...
export function IconComponentVariant({
  className = "",
  icon = "seldon-componentVariant",
  ...props
}: IconComponentVariantProps) {
  ...
  return <Icon className={"variant-icon-aGO6na " + className} {...props} />
}
const iconMap = {
