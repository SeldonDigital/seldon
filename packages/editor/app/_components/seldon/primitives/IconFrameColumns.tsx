...
export interface IconFrameColumnsProps extends SVGAttributes<SVGElement> {
  className?: string
  icon?:
    | "__default__"
...
export function IconFrameColumns({
  className = "",
  icon = "seldon-frameColumns",
  ...props
}: IconFrameColumnsProps) {
  ...
  return <Icon className={"variant-icon-7tgvO4 " + className} {...props} />
}
const iconMap = {
