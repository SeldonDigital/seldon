...
export interface ListItemStandardBoardProps
...
export function ListItemStandardBoard({
  className = "",
  buttonIconicProps,
  ...
  return (
    <HTMLLi
      className={"variant-listItemStandard-uWvetN " + className}
      {...props}
    >
      <ButtonIconic
        {...{ ...seldon.buttonIconicProps, ...buttonIconicProps }}
        className={
          "seldon-instance child-button-rzlK-G " +
      ...
      <Frame
        ...
        className={
          "seldon-instance child-frame-MhbaCA " + (frameProps?.className ?? "")
        }
      >
        <Icon
          {...{ ...seldon.frameIconProps, ...frameIconProps }}
          className={
            "seldon-instance child-icon-VgiBRr " +
        ...
        <Label
          ...
          className={
            "seldon-instance child-label-3PsLr1 " +
      ...
      <ButtonIconic
        ...
        className={
          "seldon-instance child-button-BXxw0D " +
      ...
      <ButtonIconic
        ...
        className={
          "seldon-instance child-button-Z3Wu32 " +
...
const seldon: ListItemStandardBoardProps = {
  buttonIconicProps: {},
  buttonIconicIconProps: {
