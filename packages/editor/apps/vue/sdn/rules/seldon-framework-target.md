...
This export targets **Vue**. The components in `sdn` are
Vue components.
...
Seldon can also export HTML+CSS and React. If the user wants a
HTML+CSS and React app, tell them to re-export with that target rather
