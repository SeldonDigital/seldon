...
const formControlCheckboxControlProps = computed(() => mergeSlot(sdn.formControlCheckboxControl, props.formControlCheckboxControl, props.seldonRefs))
...
const formControlCheckboxControl2Props = computed(() => mergeSlot(sdn.formControlCheckboxControl2, props.formControlCheckboxControl2, props.seldonRefs))
const inputCheckbox2Props = computed(() => mergeOptionalSlot(sdn.inputCheckbox2, props.inputCheckbox2, props.seldonRefs))
const textLabel2Props = computed(() => mergeOptionalSlot(sdn.textLabel2, props.textLabel2, props.seldonRefs))
const formControlCheckboxControl3Props = computed(() => mergeSlot(sdn.formControlCheckboxControl3, props.formControlCheckboxControl3, props.seldonRefs))
const inputCheckbox3Props = computed(() => mergeOptionalSlot(sdn.inputCheckbox3, props.inputCheckbox3, props.seldonRefs))
...
<template>
    <fieldset :class="rootClassName" v-bind="rootAttrs">
      <slot>
        ...
        <FormControlCheckboxControl v-if="formControlCheckboxControlProps !== null" v-bind="formControlCheckboxControlProps">
        ...
        <FormControlCheckboxControl v-if="formControlCheckboxControl2Props !== null" v-bind="formControlCheckboxControl2Props">
        ...
        <FormControlCheckboxControl v-if="formControlCheckboxControl3Props !== null" v-bind="formControlCheckboxControl3Props">
