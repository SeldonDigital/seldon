...
const rootClassName = computed(() => combineClassNames("sdn-bar-menus", props.className))
...
const buttonSimple4Props = computed(() => mergeSlot(sdn.buttonSimple4, props.buttonSimple4, props.seldonRefs))
