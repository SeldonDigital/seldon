...
const buttonIconic4Props = computed(() =>
  mergeSlot(sdn.buttonIconic4, props.buttonIconic4, props.seldonRefs),
)
...
<template>
  <li :class="rootClassName" v-bind="rootAttrs">
    <slot>
      ...
      />
      <ButtonIconic
        v-if="buttonIconic4Props !== null"
        v-bind="buttonIconic4Props"
        :icon="icon5Props"
      />
    </slot>
  </li>
