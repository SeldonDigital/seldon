...
const props = defineProps<{
  ...
  calendarDayMuted10?: Record<string, unknown> | null
  textLabel24?: Record<string, unknown> | null
  calendarDayMuted11?: Record<string, unknown> | null
  textLabel25?: Record<string, unknown> | null
  calendarDayMuted12?: Record<string, unknown> | null
  textLabel26?: Record<string, unknown> | null
  calendarDayMuted13?: Record<string, unknown> | null
  textLabel27?: Record<string, unknown> | null
  calendarDayMuted14?: Record<string, unknown> | null
  textLabel28?: Record<string, unknown> | null
  calendarDayMuted15?: Record<string, unknown> | null
  textLabel29?: Record<string, unknown> | null
  calendarDayMuted16?: Record<string, unknown> | null
  textLabel30?: Record<string, unknown> | null
  container5?: Record<string, unknown> | null
  calendarDayMuted17?: Record<string, unknown> | null
  textLabel31?: Record<string, unknown> | null
  calendarDayMuted18?: Record<string, unknown> | null
  textLabel32?: Record<string, unknown> | null
  calendarDayMuted19?: Record<string, unknown> | null
  textLabel33?: Record<string, unknown> | null
  calendarDayMuted20?: Record<string, unknown> | null
  textLabel34?: Record<string, unknown> | null
  calendarDayMuted21?: Record<string, unknown> | null
  textLabel35?: Record<string, unknown> | null
  calendarDayMuted22?: Record<string, unknown> | null
  textLabel36?: Record<string, unknown> | null
  calendarDayMuted23?: Record<string, unknown> | null
  textLabel37?: Record<string, unknown> | null
  container6?: Record<string, unknown> | null
  calendarDayMuted24?: Record<string, unknown> | null
  textLabel38?: Record<string, unknown> | null
  calendarDayMuted25?: Record<string, unknown> | null
...
const calendarDayMuted10Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted10, props.calendarDayMuted10, props.seldonRefs),
)
const textLabel24Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel24, props.textLabel24, props.seldonRefs),
)
const calendarDayMuted11Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted11, props.calendarDayMuted11, props.seldonRefs),
)
const textLabel25Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel25, props.textLabel25, props.seldonRefs),
)
const calendarDayMuted12Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted12, props.calendarDayMuted12, props.seldonRefs),
)
const textLabel26Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel26, props.textLabel26, props.seldonRefs),
)
const calendarDayMuted13Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted13, props.calendarDayMuted13, props.seldonRefs),
)
const textLabel27Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel27, props.textLabel27, props.seldonRefs),
)
const calendarDayMuted14Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted14, props.calendarDayMuted14, props.seldonRefs),
)
const textLabel28Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel28, props.textLabel28, props.seldonRefs),
)
const calendarDayMuted15Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted15, props.calendarDayMuted15, props.seldonRefs),
)
const textLabel29Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel29, props.textLabel29, props.seldonRefs),
)
const calendarDayMuted16Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted16, props.calendarDayMuted16, props.seldonRefs),
)
...
const calendarDayMuted17Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted17, props.calendarDayMuted17, props.seldonRefs),
)
const textLabel31Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel31, props.textLabel31, props.seldonRefs),
)
const calendarDayMuted18Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted18, props.calendarDayMuted18, props.seldonRefs),
)
const textLabel32Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel32, props.textLabel32, props.seldonRefs),
)
const calendarDayMuted19Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted19, props.calendarDayMuted19, props.seldonRefs),
)
const textLabel33Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel33, props.textLabel33, props.seldonRefs),
)
const calendarDayMuted20Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted20, props.calendarDayMuted20, props.seldonRefs),
)
const textLabel34Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel34, props.textLabel34, props.seldonRefs),
)
const calendarDayMuted21Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted21, props.calendarDayMuted21, props.seldonRefs),
)
const textLabel35Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel35, props.textLabel35, props.seldonRefs),
)
const calendarDayMuted22Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted22, props.calendarDayMuted22, props.seldonRefs),
)
const textLabel36Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel36, props.textLabel36, props.seldonRefs),
)
const calendarDayMuted23Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted23, props.calendarDayMuted23, props.seldonRefs),
)
...
const calendarDayMuted24Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted24, props.calendarDayMuted24, props.seldonRefs),
)
const textLabel38Props = computed(() =>
  mergeOptionalSlot(sdn.textLabel38, props.textLabel38, props.seldonRefs),
)
const calendarDayMuted25Props = computed(() =>
  mergeOptionalSlot(sdn.calendarDayMuted25, props.calendarDayMuted25, props.seldonRefs),
)
    ...
    <slot>
      ...
      <Frame v-bind="frame2Props">
        ...
        <Frame v-bind="container4Props" v-if="container4Props !== null">
          <CalendarDayMuted
            v-if="calendarDayMuted10Props !== null"
            v-bind="calendarDayMuted10Props"
          >
            <TextLabel v-if="textLabel24Props !== null" v-bind="textLabel24Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted11Props !== null"
            v-bind="calendarDayMuted11Props"
          >
            <TextLabel v-if="textLabel25Props !== null" v-bind="textLabel25Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted12Props !== null"
            v-bind="calendarDayMuted12Props"
          >
            <TextLabel v-if="textLabel26Props !== null" v-bind="textLabel26Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted13Props !== null"
            v-bind="calendarDayMuted13Props"
          >
            <TextLabel v-if="textLabel27Props !== null" v-bind="textLabel27Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted14Props !== null"
            v-bind="calendarDayMuted14Props"
          >
            <TextLabel v-if="textLabel28Props !== null" v-bind="textLabel28Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted15Props !== null"
            v-bind="calendarDayMuted15Props"
          >
            <TextLabel v-if="textLabel29Props !== null" v-bind="textLabel29Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted16Props !== null"
            v-bind="calendarDayMuted16Props"
          >
        ...
        <Frame v-bind="container5Props" v-if="container5Props !== null">
          <CalendarDayMuted
            v-if="calendarDayMuted17Props !== null"
            v-bind="calendarDayMuted17Props"
          >
            <TextLabel v-if="textLabel31Props !== null" v-bind="textLabel31Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted18Props !== null"
            v-bind="calendarDayMuted18Props"
          >
            <TextLabel v-if="textLabel32Props !== null" v-bind="textLabel32Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted19Props !== null"
            v-bind="calendarDayMuted19Props"
          >
            <TextLabel v-if="textLabel33Props !== null" v-bind="textLabel33Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted20Props !== null"
            v-bind="calendarDayMuted20Props"
          >
            <TextLabel v-if="textLabel34Props !== null" v-bind="textLabel34Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted21Props !== null"
            v-bind="calendarDayMuted21Props"
          >
            <TextLabel v-if="textLabel35Props !== null" v-bind="textLabel35Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted22Props !== null"
            v-bind="calendarDayMuted22Props"
          >
            <TextLabel v-if="textLabel36Props !== null" v-bind="textLabel36Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted23Props !== null"
            v-bind="calendarDayMuted23Props"
          >
        ...
        <Frame v-bind="container6Props" v-if="container6Props !== null">
          <CalendarDayMuted
            v-if="calendarDayMuted24Props !== null"
            v-bind="calendarDayMuted24Props"
          >
            <TextLabel v-if="textLabel38Props !== null" v-bind="textLabel38Props" />
          </CalendarDayMuted>
          <CalendarDayMuted
            v-if="calendarDayMuted25Props !== null"
            v-bind="calendarDayMuted25Props"
          >
