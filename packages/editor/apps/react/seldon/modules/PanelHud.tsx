...
export interface PanelHudProps extends HTMLAttributes<HTMLElement> {
...
export function PanelHud({
  ...
  const panelHudClassName = combineClassNames("sdn-panel-hud", className)
