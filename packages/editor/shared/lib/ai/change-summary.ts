...
function groupByTarget(actions: WorkspaceAction[]): Map<string, WorkspaceAction[]> {
...
function describeGroup(workspace: Workspace, id: string, actions: WorkspaceAction[]): string[] {
 ...
 */
export function describeChanges(workspace: Workspace, report: ApplyReport): string[] {
  const rows: string[] = []
