...
import type { Board, EntryNode, EntryNodeId, Workspace } from "@seldon/core/workspace/types"
...
export function getNodeChildIds(node: EntryNode, workspace: Workspace): EntryNodeId[] {
...
export function findComponentForNode(node: EntryNode, workspace: Workspace): Board | null {
