export { computeIconSet } from "./compute-icon-set"
export {
  getDefaultIncludedIcons,
  getIncludedIcons,
...
export { getIconCategoryFromId, iconBelongsToIconSet } from "./get-icon-category-from-id"
export { getIconCategoryFromPath, parseCategoryPath } from "./get-icon-category-from-path"
