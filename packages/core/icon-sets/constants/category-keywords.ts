...
export const categoryKeywords: CategoryKeyword[] = [
  {
    tokens: ["arrow", "chevron", "expand", "unfold", "keyboard", "navigate", "menu"],
    path: "user-interface/navigation",
  },
  {
    tokens: [
      "align",
  ...
  },
  {
    ...
    path: "user-interface/communication",
  },
  {
    tokens: [
      "check",
  ...
  },
  {
    ...
    path: "user-interface/actions",
  },
  {
    tokens: ["wifi", "cloud", "network", "signal", "router", "bluetooth", "cast", "link", "vpn"],
  ...
  {
    tokens: ["lock", "security", "shield", "key", "fingerprint", "password", "privacy", "admin"],
    path: "system/security",
  },
  {
    tokens: ["setting", "tune", "build", "wrench", "gear", "config", "toggle"],
  ...
  {
    tokens: ["file", "folder", "document", "archive", "attachment", "page", "note"],
    path: "content/files",
  },
  {
    tokens: ["data", "database", "storage", "table", "grid", "list", "server", "memory"],
    path: "content/data",
  },
  {
    tokens: [
  ...
  {
    tokens: ["time", "clock", "calendar", "schedule", "event", "timer", "alarm", "date", "history"],
    path: "utility/time",
  },
  {
    tokens: [
    ...
    path: "specialized/transportation",
  },
  {
    tokens: ["weather", "cloud", "rain", "snow", "sun", "storm", "wind", "temperature"],
    path: "specialized/weather",
  },
  {
    tokens: ["hospital", "health", "medical", "pharmacy", "fitness", "heart", "medicine"],
    path: "specialized/health",
  },
  {
    tokens: ["food", "restaurant", "coffee", "breakfast", "dining", "drink", "kitchen"],
    path: "specialized/food",
  },
  { tokens: ["sport", "game", "ball", "trophy", "fitness"], path: "specialized/sports" },
  {
    tokens: ["school", "education", "book", "learn", "class", "science", "lab"],
    path: "specialized/science",
  },
  {
    tokens: ["home", "house", "apartment", "hotel", "room", "household", "bed", "chair"],
    path: "specialized/household",
  },
  {
    tokens: [
      "facebook",
    ...
    path: "social-media/social",
  },
  {
    tokens: ["person", "user", "account", "profile", "people", "group", "face"],
    path: "social-media/user",
  },
]
