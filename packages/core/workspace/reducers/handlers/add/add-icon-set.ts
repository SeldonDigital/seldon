...
export function addIconSet(
  ...
  return produce(workspace, (draft) => {
    ...
    if (boardKey === DEFAULT_ICON_SET_BOARD_KEY || !ICON_SET_BOARD_CATALOG_IDS.has(boardKey)) {
      return draft
    }
    ...
    const label = stock ? stock.metadata.name : formatLabelFromCatalogId(boardKey, "Icon set")
