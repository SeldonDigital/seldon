import type { FamilyVariantSelection, VariantSelection } from "../../../../font-collections/helpers"
...
export const FONT_COLLECTION_VARIANT_SELECTION_SECTION = "variantSelection" as const
...
function writeSelection(entry: EntryFontCollection, selection: VariantSelection): void {
...
export function readFamilyVariantSelection(
  ...
  if (typeof slotSelection !== "object" || slotSelection === null || Array.isArray(slotSelection)) {
    return {}
  }
