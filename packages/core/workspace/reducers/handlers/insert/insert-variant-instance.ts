...
export function insertVariantInstance(
  ...
  const nodeToInstantiate = nodeRetrievalService.getNode(payload.variantId, workspace)
  ...
  debugLog("Workspace", "insertVariantInstance", "Insert allowed, applying with propagation", {
    propagation,
  })
  ...
  >({
    ...
    apply: (node, workspace, sourceResult) => {
      debugLog("Workspace", "insertVariantInstance", "Inserting variant instance into parent", {
  ...
  debugGroupEnd("Workspace", "insertVariantInstance", "Variant instance inserted")
