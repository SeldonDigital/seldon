 ...
 */
export function setWorkspace(payload: ExtractPayload<"set_workspace">): Workspace {
  ...
  if (cycleId) {
    throw new WorkspaceValidationError(ErrorMessages.cyclicComponentTree(cycleId), {
      type: "set_workspace",
      payload,
    })
  }
