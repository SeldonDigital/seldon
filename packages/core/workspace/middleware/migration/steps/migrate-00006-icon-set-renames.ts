 ...
 */
function themeBoardKeyMismatch(key: string, board: Board, boards: Record<string, Board>): boolean {
  return isThemeBoard(board) && key !== board.catalogId && boards[board.catalogId] === undefined
}
