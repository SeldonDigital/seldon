...
export const WORKSPACE_EDITABLE_FONT_COLLECTION_ENTRY_ID = DEFAULT_FONT_COLLECTION_ENTRY_ID
...
export function ensureWorkspaceEditableFontCollectionEntry(workspace: {
  ...
  if (!workspace["font-collections"][WORKSPACE_EDITABLE_FONT_COLLECTION_ENTRY_ID]) {
