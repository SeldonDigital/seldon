...
import type { BoardKey, Instance, InstanceId, Variant, VariantId, Workspace } from "../../types"
...
export function getNodeTheme(node: Variant | Instance, workspace: Workspace): ThemeInstanceId {
  if (node.theme) {
...
export function getInheritedTheme(node: Variant | Instance, workspace: Workspace): ThemeInstanceId {
