...
function getNodeById(workspace: Workspace, nodeId: EntryNodeId): Variant | Instance | null {
 ...
 */
export function resolveSourceNodeId(workspace: Workspace, nodeId: EntryNodeId): EntryNodeId | null {
...
export function resolveParentNodeId(workspace: Workspace, nodeId: EntryNodeId): EntryNodeId | null {
