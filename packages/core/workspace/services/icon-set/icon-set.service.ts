...
import { getIconSetTemplateCatalogId, getIconSetTemplateIconSetId } from "../../model/template-ref"

import type { IconId } from "../../../icon-sets"
import type { IconInclusion } from "../../../icon-sets/helpers/icon-selection"
import type { ComputedIconSet, IconSetTemplateId } from "../../../icon-sets/types"
...
export class WorkspaceIconSetService {
   ...
   */
  public getIconSet(iconSetId: string, workspace: Workspace): ComputedIconSet | null {
  ...
  public getBoardIconSet(boardKey: string, workspace: Workspace): ComputedIconSet | null {
