...
- Workspace theme rows should become a patch plus `instantiateTheme`, not a second persisted computed JSON blob. See [`../../workspace/README.md`](../../workspace/README.md).
