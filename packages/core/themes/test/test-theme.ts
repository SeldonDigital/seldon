...
const theme: StaticTheme = {
  ...
  color: {
    baseColor: { hue: 0, saturation: 0, lightness: 15 }, // Base color for the swatches
    ...
    step: 15, // Steps between tints and shades; (+) values create tints, (-) values create shades
    whitePoint: 98, // Used to determine lightness value for white
    grayPoint: 56, // Used to determine lightness value for gray
    blackPoint: 8, // Used to determine lightness value for black
    bleed: 12, // Determines how much the hue bleeds into white, gray, and black
