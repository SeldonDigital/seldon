...
export const theme: StockTheme = {
  metadata: {
    ...
    description:
      "A theme aligned with Material Design 3. It pairs the Roboto type family with the M3 baseline palette of purple primary, neutral secondary, and muted tertiary tones, set on a dark neutral surface with restrained elevation.",
    intent:
      "To provide a clean, systematic look based on Material Design 3 tokens, suitable for product and application interfaces.",
  },
  modulation: {
  ...
  colorHarmony: {
    type: TokenType.COMPUTED,
    parameters: {
      baseColor: { hue: 256, saturation: 37, lightness: 46 },
  ...
  swatch: {
    ...
    foreground: {
      ...
      parameters: {
        ...
        value: { hue: 260, saturation: 10, lightness: 95 },
      },
    },
    background: {
      name: "Background",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 260, saturation: 12, lightness: 9 },
      },
    },
    active: {
      name: "Active",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 256, saturation: 37, lightness: 46 },
      },
    },
    punch: {
      name: "Punch",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 25, saturation: 68, lightness: 51 },
      },
    },
    positive: {
      name: "Positive",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 141, saturation: 50, lightness: 38 },
      },
    },
    warning: {
      name: "Warning",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 42, saturation: 98, lightness: 43 },
      },
    },
    accent: {
      name: "Accent",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 330, saturation: 39, lightness: 49 },
      },
    },
    custom1: {
      name: "Secondary",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 259, saturation: 12, lightness: 38 },
      },
    },
    custom2: {
      name: "Tertiary",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 340, saturation: 22, lightness: 39 },
      },
    },
    negative: {
      name: "Negative",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 2, saturation: 74, lightness: 39 },
      },
    },
    offBlack: {
      name: "Off Black",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 260, saturation: 10, lightness: 12 },
      },
    },
    offWhite: {
      name: "Off White",
      ...
      parameters: {
        colorspace: Colorspace.HSL,
        value: { hue: 260, saturation: 8, lightness: 96 },
      },
    },
  },
  font: {
