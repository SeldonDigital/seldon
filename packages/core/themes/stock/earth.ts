...
const theme: StockTheme = {
  metadata: {
    ...
    name: "Earthtones",
    description:
      "A warm and natural theme with an earthy color palette inspired by nature. It features customizable typography, layout, and color options to suit various design needs.",
    intent:
  ...
  swatch: {
    ...
    background: {
      ...
      parameters: { colorspace: Colorspace.HSL, value: { hue: 18, saturation: 12, lightness: 8 } },
    },
    custom1: {
      name: "Soft Green",
      intent: "A softer version of RIJKS green.",
      type: TokenType.SWATCH,
      parameters: { colorspace: Colorspace.HSL, value: { hue: 38, saturation: 18, lightness: 76 } },
    },
    custom2: {
      name: "Green",
      intent: "An earthy green to be used a complimentary color for content",
      type: TokenType.SWATCH,
      parameters: { colorspace: Colorspace.HSL, value: { hue: 72, saturation: 18, lightness: 55 } },
    },
    custom3: {
      name: "Pure Green",
      intent: "A richer version of RIJKS green.",
      type: TokenType.SWATCH,
      parameters: { colorspace: Colorspace.HSL, value: { hue: 158, saturation: 18, lightness: 37 } },
    },
  },
  font: {
    display: {
