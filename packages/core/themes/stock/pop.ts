...
const theme: StockTheme = {
  metadata: {
    ...
    intent:
      "To provide a striking and dynamic look with high contrast and readability, suitable for a wide range of applications.",
  },
  core: {
  ...
  color: {
    baseColor: { hue: 352, saturation: 85, lightness: 68 },
  ...
  fontFamily: {
    primary: { type: TokenType.FONT_FAMILY, parameters: "Playfair Display" },
    secondary: { type: TokenType.FONT_FAMILY, parameters: "Josefin Sans" },
  },
  size: {
    tiny: {
  ...
  swatch: {
    ...
    background: {
      ...
      parameters: { colorspace: Colorspace.HSL, value: { hue: 352, saturation: 12, lightness: 8 } },
    },
    custom4: {
      name: "Charcoal",
      intent: "A low contrast black color.",
      type: TokenType.SWATCH,
      parameters: { colorspace: Colorspace.HSL, value: { hue: 197, saturation: 8, lightness: 18 } },
    },
  },
  font: {
    display: {
