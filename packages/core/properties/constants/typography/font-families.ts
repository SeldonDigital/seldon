/** One Google Font family and every variant string Google lists for that family. */
export type GoogleFontFamily = {
  family: string
  variants: string[]
}

/** Full catalog the font picker reads when it adds Google Font choices next to theme faces. */
export const GOOGLE_FONT_FAMILIES: GoogleFontFamily[] = [
  {
    family: "Abel",
    variants: ["regular"],
  },
