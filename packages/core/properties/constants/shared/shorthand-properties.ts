 ...
 */
export const PROPERTY_SHORTHAND_KEYS = ["margin", "padding", "corners", "position"] as const

export type PropertyShorthandCatalogKey = (typeof PROPERTY_SHORTHAND_KEYS)[number]
