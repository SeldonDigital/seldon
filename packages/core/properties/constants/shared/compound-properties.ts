...
export const COMPOUND_FACET_DISPLAY_ORDER: Record<string, readonly string[]> = {
  ...
  border: ["preset", "style", "color", "width", "brightness", "opacity", "collapse"],
  borderTop: ["preset", "style", "color", "width", "brightness", "opacity", "collapse"],
  borderRight: ["preset", "style", "color", "width", "brightness", "opacity", "collapse"],
  borderBottom: ["preset", "style", "color", "width", "brightness", "opacity", "collapse"],
  borderLeft: ["preset", "style", "color", "width", "brightness", "opacity", "collapse"],
  font: [
    "preset",
    "family",
    "style",
