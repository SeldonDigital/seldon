...
/** Unset or a percentage from 0 through 100 that lightens or darkens one background layer. */
...
export const backgroundBrightnessSchema: PropertySchema = {
  ...
  description:
    "Sets how much lighter or darker this layer reads, from 0 through 100 percent.",
