...
/** Unset or a percentage from -100 through 100 that lightens or darkens the element. */
export type BrightnessValue = EmptyValue | PercentageValue

export const brightnessSchema: PropertySchema = {
  name: "brightness",
  description: "Sets how much lighter or darker the element reads, from -100 through 100 percent.",
