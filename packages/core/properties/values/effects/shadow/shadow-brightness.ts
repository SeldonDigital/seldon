...
/** Unset or a percentage from 0 through 100 that lightens or darkens the shadow. */
...
export const shadowBrightnessSchema: PropertySchema = {
  ...
  description:
    "Sets how much lighter or darker the shadow reads, from 0 through 100 percent.",
