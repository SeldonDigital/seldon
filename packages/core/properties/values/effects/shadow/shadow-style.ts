...
export const shadowStyleSchema: PropertySchema = {
  name: "shadowStyle",
  description: "Sets whether the shadow renders outside the element or inset within it.",
  supports: ["empty", "inherit", "option"] as const,
  validation: {
    empty: () => true,
    inherit: () => true,
    option: (value: unknown) =>
      typeof value === "string" && (Object.values(ShadowStyle) as string[]).includes(value),
  },
