...
import { Color, ColorValue } from "../../appearance/color"
import { EmptyValue } from "../../shared/empty/empty"

/** Unset or full element color storage used on one gradient stop. */
export type GradientStopColorValue = EmptyValue | ColorValue

/** Validates stored gradient stop color values. */
export const gradientStopColorSchema: PropertySchema = {
  name: "gradientStopColor",
  description:
    "Sets this stop's paint from literals, color objects, theme swatches, or computed rules.",
  supports: [
    "empty",
    "inherit",
    "exact",
