...
export type ObjectFacetCompoundValue = BorderCompound | FontCompound | BoardCompound

/** One layer in a background, gradient, or shadow list. */
export type PaintStackLayerValue = BackgroundLayer | GradientCompound | ShadowCompound

/** Union of facet maps and single paint layers for the compound branch of {@link Value}. */
export type CompoundBranchPayload = ObjectFacetCompoundValue | PaintStackLayerValue
