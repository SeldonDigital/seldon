...
/**
 * Workspace fixture for unit tests with a product card structure.
 *
 * Contains a complete workspace focused on product card components with
 * textblock details and button bar hierarchies. Used for testing component
 * relationships and workspace operations.
 */
export const WORKSPACE_WITH_PRODUCT_CARD_FIXTURE = {
  version: 13,
  customTheme,
  boards: {
    cardProduct: {
