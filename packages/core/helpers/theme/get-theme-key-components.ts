...
import type { Theme, ThemeOptionId, ThemeTokenNamespace, ThemeValueKey } from "../../themes/types"
 ...
 */
export function parseThemeRef(value: unknown): { section: string; optionId: string } | null {
