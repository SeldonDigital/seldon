...
import type { Theme, ThemeOption } from "../../themes/types"
...
export function resolveColor({
  ...
  if (!color || typeof color !== "object" || !color.type) {
    debugLog("Workspace", "resolveColor", "Invalid color object, falling back to empty value", {
  ...
  switch (color.type) {
    ...
    default:
      debugLog("Workspace", "resolveColor", "Invalid color type, falling back to empty value", {
