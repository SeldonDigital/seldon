...
export const schema = {
  name: "YouTube Ad",
  id: Seldon.ComponentId.AD_YOU_TUBE,
  intent:
    "Specifies YouTube ad types such as skippable, non-skippable, and bumper formats with targeting and media asset controls.",
  tags: [
    "ads",
    "youtube",
    "video",
