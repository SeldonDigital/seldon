...
export const schema = {
  name: "Instagram Ad",
  id: Seldon.ComponentId.AD_INSTAGRAM,
  intent:
    "Structures ad components tailored for Instagram campaigns, including story, reel, and feed variations with required metadata.",
  tags: [
    "ads",
    "instagram",
    "social",
