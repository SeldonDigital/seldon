...
export const schema = {
  name: "LinkedIn Ad",
  id: Seldon.ComponentId.AD_LINKED_IN,
  intent:
    "Describes LinkedIn-specific ad units for enterprise campaigns, including sponsored content, job posts, and B2B targeting controls.",
  tags: [
    "ads",
    "linkedin",
    "b2b",
