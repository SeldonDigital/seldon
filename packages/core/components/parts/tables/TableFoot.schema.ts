...
export const schema = {
  name: "Table Foot",
  id: Seldon.ComponentId.TABLE_FOOT,
  intent:
    "Schema for rendering table footers, typically used for summaries, totals, or end-of-table actions and annotations.",
  tags: [
    "table",
    "footer",
    "foot",
