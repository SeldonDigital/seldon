# Seldon Components Architecture
...
Components can only contain equal or lower-level components. Primitives cannot have children.
...
All components must validate against their documented schemas:
