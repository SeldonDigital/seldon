...
export const schema = {
  name: "Tools",
  id: Seldon.ComponentId.BUTTON_TOOLS,
  intent: "Hosts a set of utility controls or actions grouped in a toolbar.",
  tags: [
    "toolbar",
    "actions",
    "controls",
  ...
  children: [
    ...
    },
    {
      ...
      nestedOverrides: {
        icon: {
          symbol: "seldon-toolSketch",
          size: "@size.medium",
        },
        label: { content: "Sketch" },
      },
    },
    {
      component: Seldon.ComponentId.BUTTON,
