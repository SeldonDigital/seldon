...
export const schema = {
  name: "Chip Count",
  id: Seldon.ComponentId.CHIP_COUNT,
  intent:
    "Defines a chip component variant that displays a numeric count, often used for notifications, filters, or grouped item indicators.",
  tags: [
    "chip",
    "count",
    "ui",
