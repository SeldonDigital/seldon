...
| --- | --- | --- |
| **Atomic** | `color`, `display`, `opacity`, `letterSpacing` | Single tagged value. |
...
License and contributor documents live at the **repository root** under [`docs/LICENSES/`](../../../docs/LICENSES/README-NOTICE.md) (full tree: `terminus/docs/LICENSES/`). Links in this section resolve from `packages/core/components/` via `../../../docs/…`.
